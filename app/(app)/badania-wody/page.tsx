...
import {
  FlaskConical, Paperclip, X, FileText, ExternalLink, Search, ChevronRight,
} from 'lucide-react'
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        <SectionHeader title="Historia badań" actionLabel="Nowy wpis" onAction={() => setShowModal(true)} />
        {rows.length > 0 ? (
      ...
      {/* ── New entry modal ── */}
      <Dialog open={showModal} onClose={() => setShowModal(false)} title="Nowe badanie wody" size="md">
        <div className="space-y-4">
          <AiScanRow
            label="Skanuj zdjęcie / PDF AI"
            files={scanFiles}
