...
const PROMPT = `Przeanalizuj to orzeczenie lekarskie do celów sanitarno-epidemiologicznych (może się składać z kilku stron / zdjęć tego samego dokumentu) i wyciągnij dane pracownika.
